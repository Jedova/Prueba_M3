...
if opcion == "0":
    print()
    time.sleep(2)
    os.system(op_sys) # finalizar programa
...
while correcto and n_pregunta < 3 * p_level:
    if continuar == "y":
        ...
        print_pregunta(enunciado, [alt[0] for alt in alternativas])     
        ...
        if correcto and n_pregunta < 3 * p_level: #Evaluación del resultado
